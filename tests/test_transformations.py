...
from bids_statsmodels_design_synthesizer import transformations as transform
...
def test_convolve(collection):
    ...
    with mock.patch('bids_statsmodels_design_synthesizer.transformations.compute.hrf') as mocked:
